...
void IPEdit::textChanged(const QString &text)
{
    int len = text.length();
...
QSize IPEdit::minimumSizeHint() const
{
    return QSize(30, 10);
}
...
void IPEdit::setBgColor(const QString &bgColor)
{
...
void IPEdit::setBorderColor(const QString &borderColor)
{
...
void IPEdit::setBorderRadius(int borderRadius)
{
